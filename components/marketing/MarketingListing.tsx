...
export function MarketingListing({ locale, kind, items, allItems, q, industry }: { locale: Locale; kind: Kind; items: Array<Solution | Scenario>; allItems: Array<Solution | Scenario>; q?: string; industry?: string }) {
